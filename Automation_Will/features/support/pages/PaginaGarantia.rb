  ...
  def seleciona_garantia(tipo_garantia)
    ...
    has_selector?(EL['planos_garantia_extendida_EX'], wait:15, visible: true) if $site == 'extra'
        ...
        when "12_meses"
          ...
          all(EL['radio_planos_CB_pai'], wait: 5)[0].click if $site == 'casasbahia'
          find(EL['radio_planos_PF_BT_12m']).click if $site == 'pontofrio'
          find(EL['radio_planos_PF_BT_12m']).click if $site == 'barateiro'
        ...
        when "24_meses"
          all(EL['radio_planos_CB_pai'], wait: 5)[1].click if $site == 'casasbahia'
          find(EL['botao_contratar_24m_EX']).click if $site == 'extra'
          find(EL['radio_planos_PF_BT_24m']).click if $site == 'pontofrio'
          find(EL['radio_planos_PF_BT_24m']).click if $site == 'barateiro'
          # Common.new.clica_elemento("botao_RecusaGarantia",0) if $site == 'casasbahia'
          # Common.new.clica_elemento('botao_continuar_garantia_r') if $site == 'pontofrio'
          # Common.new.clica_elemento('botao_continuar_garantia_r') if $site == 'barateiro'
        else
          find(EL['radio_planos_CB_PF_BT_36m']).click if $site == 'extra'
          all(EL['radio_planos_CB_pai'], wait: 5)[2].click if $site == 'casasbahia'
          find(EL['radio_planos_PF_BT']).click if $site == 'pontofrio'
          find(EL['radio_planos_PF_BT']).click if $site == 'barateiro'
          # Common.new.clica_elemento("botao_RecusaGarantia",0) if $site == 'casasbahia'
          # Common.new.clica_elemento('botao_continuar_garantia_r') if $site == 'pontofrio'
          # Common.new.clica_elemento('botao_continuar_garantia_r') if $site == 'barateiro'
        end
